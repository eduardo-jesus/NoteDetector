...
int main1( int argc, char** argv )
{
    ...
    cout << "object keypoints: " << keypoints_object.size() << endl;
    cout << "object descriptors: " << descriptors_object.rows << endl;
    cout << "scene keypoints: " << keypoints_scene.size() << endl;
    cout << "scene descriptors: " << descriptors_scene.rows << endl;
